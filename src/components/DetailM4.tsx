...
export default function DetailM4() {
  const images = [image ];
      ...
      <body className="bg-white">
        <section className="body-font overflow-hidden text-gray-600">
          ...
          <Breadcrumb aria-label="Default breadcrumb example">
              ...
              <BreadcrumbItem>Excavadora Caterpillar 320E</BreadcrumbItem>
            </Breadcrumb>
            <div className="mx-auto flex flex-wrap lg:w-4/5">
              <div className="mb-6 w-full lg:mb-0 lg:w-1/2 lg:py-6 lg:pr-10">
                ...
                <p className="mb-4 leading-relaxed">
                  Excavadora con un peso de 22.5 toneladas, cuchara de 1.00 m de
                  ancho y 1.19 m³ de capacidad. Tracción en orugas y longitud de
                  transporte de 9.54 m.{" "}
                </p>
